...
// Ponto turístico específico (ex.: cliente já escolheu "Rio de Janeiro" como
// destino e quer sinalizar interesse em conhecer o Cristo Redentor lá dentro).
export const landmarks: string[] = [
  ...
  "Basílica de Aparecida — São Paulo",
